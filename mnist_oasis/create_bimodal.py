...
if __name__ == '__main__':
    ...
    train_oasis = pd.read_csv('/home/agathe/Code/datasets/OASIS-1_dataset/tsv_files/lab_1/train.tsv', sep='\t')
    test_oasis = pd.read_csv('/home/agathe/Code/datasets/OASIS-1_dataset/tsv_files/lab_1/validation.tsv', sep='\t')
    ...
    torch.save(idx1, 'data/train-mo-mnist-idx.pt')
    torch.save(idx2, 'data/train-mo-oasis-idx.pt')
    ...
    torch.save(idx1[shuffle], 'data/test-mo-mnist-idx.pt')
    torch.save(idx2[shuffle], 'data/test-mo-oasis-idx.pt')
